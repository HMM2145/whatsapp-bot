...
» $tts Contoh: $tts Didin ganteng (${BotName} akan mengirim link download)
» $say Contoh: $say halo Didin ganteng
» $quran Contoh: $quran
...
» $lirik Contoh: $lirik
» $nulis Contoh: $nulis Didin Gans
» $fotoanime Contoh: $fotoanime
» $covid Contoh: $covid
» $nama Contoh $nama Didin
» $pasangan Contoh: $pasangan Didin & sayang
» #info Contoh: #info
